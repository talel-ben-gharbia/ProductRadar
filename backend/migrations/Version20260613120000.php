...
final class Version20260613120000 extends AbstractMigration
{
    ...
    {
        return 'Add image_status and image_last_checked_at columns to product table';
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP image_status');
        $this->addSql('ALTER TABLE product DROP image_last_checked_at');
    }
}
