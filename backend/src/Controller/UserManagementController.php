...
final class UserManagementController extends AbstractController
{
    ...
    private function serializeUser(User $user, int $alertsUsed = 0, int $favoritesUsed = 0): array
    {
        ...
        return [
            ...
            'name' => $user instanceof B2BCompany || $user instanceof B2BMarket ? $user->getName() : null,
            'sector' => $user instanceof B2BCompany || $user instanceof B2BMarket ? $user->getSector() : null,
